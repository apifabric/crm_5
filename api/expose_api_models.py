...
def expose_models(api, method_decorators = []): 
    ...
    api.expose_object(database.models.Country, method_decorators= method_decorators)
    ...
    api.expose_object(database.models.EmployeeDepartment, method_decorators= method_decorators)
    ...
    api.expose_object(database.models.ProductCategory, method_decorators= method_decorators)
    api.expose_object(database.models.ProductSupplier, method_decorators= method_decorators)
